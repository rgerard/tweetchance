...
// Store the last bet received.
var bet;

// Counter to store and display the number of new bets when notifications are disabled.
var news = 0;
...
// each time our Node server send us a new bet.
socket.on('message', function(data){
    ...
    if(window.localStorage.noticationEnable == 'true'){
        var notification = webkitNotifications.createNotification('icon.png', 'Hello', bet);
        notification.show();
    } else{
